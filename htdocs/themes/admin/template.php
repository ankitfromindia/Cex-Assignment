        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/catalog')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button catalog'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/categories') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/categories'); ?>"><?php echo lang('admin button categories'); ?></a></li>
                            <li class="<?php echo (uri_string() == 'admin/products') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/products'); ?>"><?php echo lang('admin button products'); ?></a></li>
                        </ul>
                    </li>
                    <li class="dropdown<?php echo (strstr(uri_string(), 'admin/orders')) ? ' active' : ''; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo lang('admin button orders'); ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?php echo (uri_string() == 'admin/orders') ? 'active' : ''; ?>"><a href="<?php echo base_url('/admin/orders'); ?>"><?php echo lang('admin button orders_list'); ?></a></li>
                            </ul>
                    </li>
