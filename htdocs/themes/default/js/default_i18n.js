...
jQuery(document).ready(function($){
	...
	function addProduct(trigger) {
                $.post('/ajax/cart_add_product', {
                    ...
                    {
                        //update cart counter;
                        productId = trigger.data('product');
                        var productAdded = response.html;
                        cartList.html(productAdded);
                        var cartIsEmpty = cartWrapper.hasClass('empty');
                        //update number of items 
                        updateCartCount(false, response.item_count);
                        //update total price
                        updateCartTotal(response.total, true);
